---
layout: post
title: "scaleai - [Annotations] Operations Associate"
date: 2026-06-15
company: "scaleai"
role: "[Annotations] Operations Associate"
...
`Operations` `Annotations` `Cross-functional Collaboration` `Process Optimization` `Data Operations` `Supply Management` `Pilot Testing` `Revenue Driving` `Customer Commitments` `Problem Solving`

---

## 공고 요약

Scale AI의 Operations Associate는 고객 약속을 적시에 이행하고 최고 품질 기준을 유지하여 매출을 창출하는 역할입니다. 공급 운영 파이프라인을 관리하고, 고객 운영·제품 팀 등 다양한 부서와 협력하여 솔루션과 프로세스를 구축합니다. 전례 없는 문제를 해결하며 파일럿 테스트와 실험을 주도적으로 진행해야 합니다. 분석적이고 결과 중심적인 사람을 찾으며, Scale AI의 핵심 일상 운영을 담당하는 중요한 포지션입니다.
...
- 운영 프로세스 구축 및 관리 경험
- 데이터 기반 분석 및 문제 해결 능력
- 고객 팀, 제품팀 등 다양한 부서와의 협업(Cross-functional) 경험
- 파일럿 테스트 및 실험 설계·실행 역량
- 멕시코시티 근무 가능 및 영어 커뮤니케이션 능력

---

## 추천 대상

- 스타트업 또는 테크 기업에서 운영(Operations) 업무를 경험한 사람
- 데이터 분석을 통해 프로세스 개선을 주도해본 사람
- 불확실한 환경에서 자기 주도적으로 문제를 해결하는 것을 즐기는 사람
- 다양한 팀과 협력하며 결과 중심으로 일하는 것을 선호하는 사람
- AI/데이터 산업에 관심이 있고 빠르게 성장하는 환경을 원하는 사람
