---
layout: post
title: "scaleai - Machine Learning Systems Research Engineer, Agent Post-training - Enterprise GenAI"
date: 2026-06-13
company: "scaleai"
...
`Machine Learning` `Reinforcement Learning` `Post-training` `Agent Training` `Generative AI` `ML Systems` `Large Scale Training` `RL Platform` `Enterprise AI` `Algorithm Development`

---

## 공고 요약

Scale AI는 엔터프라이즈 GenAI 부문의 ML 시스템 리서치 엔지니어를 샌프란시스코 또는 뉴욕에서 채용합니다. 이 역할은 차세대 Agent RL 학습 플랫폼의 알고리즘 개발과 대규모 학습 시스템 지원을 담당합니다. Meta의 투자를 기반으로 복잡한 엔터프라이즈 에이전트 구현을 위한 최첨단 포스트트레이닝 알고리즘 연구에 집중하는 포지션입니다. 내부 MLRE 및 AAI 팀을 고객으로 삼아 ML 시스템 최적화 기술을 연구하고 통합하는 역할을 수행합니다.

---

## 필수 지원 조건

- 강화학습(RL) 및 대규모 ML 학습 시스템에 대한 깊은 이해
- 포스트트레이닝 알고리즘 설계 및 구현 경험
- 대규모 분산 학습 인프라 구축 및 최적화 경험
- AI 에이전트 또는 생성형 AI 관련 연구/개발 경험

---

## 추천 대상

- 강화학습 기반 LLM 파인튜닝(RLHF 등) 경험자
- 대규모 ML 인프라 및 분산 학습 시스템을 다뤄본 엔지니어
- AI 에이전트 시스템 연구 및 프로덕션 적용 경험이 있는 연구자
- 엔터프라이즈 AI 솔루션 개발에 관심 있는 ML 시스템 엔지니어
