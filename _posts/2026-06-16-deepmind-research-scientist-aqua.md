---
layout: post
title: "deepmind - Research Scientist, AQUA"
date: 2026-06-16
company: "deepmind"
role: "Research Scientist, AQUA"
...
`Reinforcement Learning` `Large Language Models` `AGI` `Machine Learning` `Research Scientist` `Agentic AI` `Gemini` `Deep Learning` `NLP` `Foundational Models`

---

## 공고 요약

Google DeepMind 인도 Bangalore 팀에서 AGI 실현을 목표로 하는 Research Scientist를 채용합니다. 주요 업무는 대형 모델 기반의 에이전트 행동 연구 및 강화학습 알고리즘 개발입니다. 연구 성과는 Google의 Gemini 모델과 주요 제품에 직접 적용되어 수억 명의 사용자에게 영향을 미칩니다. AI 안전성과 윤리를 최우선으로 하며, 최첨단 AI 연구를 실제 서비스에 연결하는 역할을 담당합니다.

---

## 필수 지원 조건

- 강화학습(RL) 및 대형 언어 모델(LLM) 관련 연구 경험
- 머신러닝/AI 분야 석사 또는 박사 학위 (또는 동등한 연구 경력)
- AI 에이전트 또는 파운데이션 모델 연구 논문 발표 실적
- 대규모 모델 학습 및 실험 설계 능력
- Python 등 ML 프레임워크 활용 개발 능력

---

## 추천 대상

- 강화학습과 LLM의 교차 분야에 관심 있는 AI 연구자
- AGI 및 에이전트 AI 분야에서 임팩트 있는 연구를 원하는 분
- 학문적 연구 성과를 실제 대규모 제품에 적용해보고 싶은 분
- Google DeepMind 수준의 최첨단 AI 연구 환경을 원하는 분
- 인도 Bangalore에서 글로벌 AI 연구팀과 협업하고 싶은 분
