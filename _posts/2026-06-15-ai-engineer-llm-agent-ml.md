---
layout: post
title: "몬드리안에이아이 - AI Engineer (LLM Agent / ML)"
date: 2026-06-15
company: "몬드리안에이아이"
role: "AI Engineer (LLM Agent / ML)"
location: "인천"
source: "wanted"
...
`LLM` `AI Agent` `MLOps` `Machine Learning` `NLP` `Python` `Deep Learning` `Knowledge Graph` `Time Series` `Computer Vision`

---

## 공고 요약

몬드리안에이아이는 AI 클라우드 및 플랫폼 전문 기업으로, LLM Agent 및 ML 모델 개발을 담당할 AI 엔지니어를 채용합니다. AI 연구팀에서 LLM Agent, Knowledge 기반 Copilot, 시계열·비전 ML 모델 등 다양한 AI 기술을 활용한 산업용 솔루션 개발에 참여하게 됩니다. 매년 150% 매출 성장을 기록 중인 빠르게 성장하는 스타트업으로, 인천에 위치해 있습니다. KAIST 연구진 출신의 기술 기반 기업으로 삼성·SK·Dell 등 글로벌 기업을 고객사로 보유하고 있습니다.

---

## 필수 지원 조건

- LLM Agent 또는 ML 모델 개발 실무 경험
- Python 기반 AI/ML 개발 역량
- 딥러닝 프레임워크(PyTorch 등) 활용 능력
- AI 모델 설계부터 배포까지 전주기 개발 경험

---

## 추천 대상

- LLM 기반 에이전트 시스템 개발에 관심 있는 AI 엔지니어
- MLOps 플랫폼 또는 산업용 AI 솔루션 개발 경험자
- 빠르게 성장하는 AI 스타트업에서 다양한 도메인(제조, 클라우드 등)을 경험하고 싶은 개발자
- 시계열·비전·NLP 등 멀티 도메인 ML 프로젝트에 참여하고 싶은 연구자
