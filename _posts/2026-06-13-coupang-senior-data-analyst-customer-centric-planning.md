---
layout: post
title: "coupang - Senior Data Analyst (Customer-Centric Planning)"
date: 2026-06-13
company: "coupang"
role: "Senior Data Analyst (Customer-Centric Planning)"
...
`Data Analytics` `SQL` `Python` `Data Infrastructure` `E-commerce` `Customer Analytics` `ETL` `Business Intelligence` `Data Pipeline` `Rocket Delivery`

---

## 공고 요약

쿠팡 대만 법인에서 고객 중심 플래닝 팀의 시니어 데이터 애널리스트를 채용합니다. 단순 데이터 분석을 넘어 데이터 인프라를 직접 구축할 수 있는 엔지니어링 마인드셋을 갖춘 인재를 찾고 있습니다. 대만 이커머스 시장에서 쿠팡의 성장을 데이터 관점에서 이끌어갈 핵심 역할입니다. 로켓배송 및 로켓직구 서비스의 고객 경험 향상에 직접 기여하게 됩니다.

---

## 필수 지원 조건

- 데이터 분석 및 데이터 인프라 구축 경험 보유
- SQL 및 Python 등 데이터 처리 도구 활용 능력
- 이커머스 또는 플래닝 관련 도메인 경험
- 영어 또는 중국어 비즈니스 커뮤니케이션 가능

---

## 추천 대상

- 데이터 분석과 데이터 엔지니어링을 모두 경험한 분
- 이커머스 플랫폼에서 고객 데이터 분석 경험이 있는 분
- 대만 또는 글로벌 테크 기업에서 커리어를 쌓고 싶은 분
- 데이터 기반 의사결정 문화를 선호하는 분
