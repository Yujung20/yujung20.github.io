---
layout: post
title: "오토메타 - Data Curation Engineer (데이터 큐레이션 엔지니어)"
date: 2026-06-20
company: "오토메타"
role: "Data Curation Engineer (데이터 큐레이션 엔지니어)"
location: "서울"
source: "wanted"
link: "https://www.wanted.co.kr/wd/369511"
---
 
## 링크
 
https://www.wanted.co.kr/wd/369511
...
• 기업 데이터를 AI가 이해할 수 있는 Op

---

## 핵심 키워드

`Data Curation` `Ontology` `AI` `LLM` `RAG` `Knowledge Graph` `NLP` `Data Engineering` `RLHF` `Machine Learning`

---

## 공고 요약

오토메타는 AI 기반 오케스트레이션 플랫폼 'Zenith AI'를 개발하는 기업으로, 데이터 큐레이션 엔지니어를 채용합니다. 주요 업무는 기업 데이터를 AI가 이해할 수 있도록 도메인 지식과 온톨로지를 구축하는 것입니다. BMW, LG, Samsung 등 다양한 글로벌 파트너와 협력하며 금융·유통·공공 등 폭넓은 산업 도메인에서 데이터 작업을 수행합니다. 자율과 책임 기반의 성과 중심 문화 속에서 AI 데이터 파이프라인 전반을 담당할 인재를 찾고 있습니다.

---

## 필수 지원 조건

- 도메인 지식 기반 온톨로지 설계 및 구축 경험
- LLM/RAG 파이프라인을 위한 데이터 가공 및 큐레이션 능력
- 구조화·비구조화 데이터 처리 및 정제 역량
- AI 학습용 데이터셋 구축 및 품질 관리 경험

---

## 추천 대상

- 온톨로지·지식그래프 구축에 관심 있는 데이터 엔지니어
- LLM 파인튜닝 또는 RAG 시스템용 데이터 파이프라인 경험자
- 다양한 산업 도메인의 데이터를 다뤄보고 싶은 분
- AI 제품 개발의 데이터 기반을 직접 설계하고 싶은 분
