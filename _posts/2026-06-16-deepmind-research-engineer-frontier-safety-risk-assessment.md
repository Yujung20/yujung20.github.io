---
layout: post
title: "deepmind - Research Engineer, Frontier Safety Risk Assessment"
date: 2026-06-16
company: "deepmind"
role: "Research Engineer, Frontier Safety Risk Assessment"
location: "London, UK; New York City, New York, US; San Francisco, California, US"
source: "greenhouse"
...
`AI Safety` `Risk Assessment` `Frontier AI` `Machine Learning` `CBRN` `Empirical Evaluation` `Research Engineering` `AI Alignment` `Catastrophic Risk` `Safety Mitigation`

---

## 공고 요약

Google DeepMind의 Frontier Safety Risk Assessment 팀은 현재 및 미래 AI 시스템의 잠재적 재앙적 위험을 평가하고 완화하는 연구 엔지니어를 찾고 있습니다. 이 역할은 AI 통제 상실, 자동화된 ML R&D 오용, CBRN(화학·생물·방사선·핵) 위협 및 사이버 피해 등 다양한 위험 시나리오를 기술적으로 설계하고 검증하는 업무를 포함합니다. 런던, 뉴욕, 샌프란시스코 중 한 곳에서 근무하며 AI 안전성과 윤리를 최우선으로 하는 팀과 협력하게 됩니다.

---

## 필수 지원 조건

- AI 안전성 또는 머신러닝 관련 연구 및 엔지니어링 경험
- 위험 평가 방법론 설계 및 실증적 검증 능력
- 프론티어 AI 시스템의 위험 식별 및 완화 전략 수립 역량
- CBRN, 사이버 보안 등 광범위한 위협 도메인에 대한 이해

---

## 추천 대상

- AI 안전성(AI Safety) 및 정렬(Alignment) 연구에 관심 있는 머신러닝 엔지니어
- 대규모 AI 시스템의 위험 평가 및 레드팀(Red Teaming) 경험이 있는 연구자
- 사이버 보안, 생물안보 등 신흥 기술 위협 분야 배경을 가진 전문가
- 인류에 미치는 AI의 장기적 영향에 깊은 관심을 가진 기술 연구자
