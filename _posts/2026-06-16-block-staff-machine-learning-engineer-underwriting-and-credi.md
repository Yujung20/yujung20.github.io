---
layout: post
title: "block - Staff Machine Learning Engineer, Underwriting and Credit"
date: 2026-06-16
company: "block"
role: "Staff Machine Learning Engineer, Underwriting and Credit"
...
`Machine Learning` `Underwriting` `Credit Risk` `Financial Services` `Staff Engineer` `ML Systems` `Risk Modeling` `Cash App` `Square` `Fintech`

---

## 공고 요약

Block(Square/Cash App 모회사)은 신용 및 언더라이팅 분야의 Staff ML 엔지니어를 채용합니다. 이 역할은 대규모 금융 생태계에서 신용 리스크 모델링 및 머신러닝 시스템을 설계·구축하는 핵심 포지션입니다. 수백만 명의 개인과 비즈니스를 대상으로 하는 금융 접근성 확대 미션에 기여하게 됩니다. 신뢰와 안전을 기반으로 한 금융 플랫폼의 ML 인프라를 이끌 시니어급 엔지니어를 찾고 있습니다.

---

## 필수 지원 조건

- 머신러닝 엔지니어링 분야의 깊은 전문성 및 Staff급 경력
- 신용 리스크, 언더라이팅, 또는 금융 서비스 관련 ML 모델 개발 경험
- 대규모 분산 시스템 환경에서의 ML 파이프라인 설계 및 운영 경험
- 금융 도메인 데이터를 활용한 리스크 모델링 또는 사기 탐지 경험

---

## 추천 대상

- 핀테크 또는 금융 서비스 분야에서 신용/리스크 ML 모델을 개발한 경험이 있는 시니어 엔지니어
- 대규모 소비자 플랫폼에서 ML 시스템을 설계하고 오너십을 가지고 이끌어본 경험자
- 금융 포용성(financial inclusion) 미션에 공감하며 임팩트 있는 제품을 만들고 싶은 개발자
- Bay Area에서 글로벌 분산 조직 문화 속에서 일하고 싶은 ML 엔지니어
