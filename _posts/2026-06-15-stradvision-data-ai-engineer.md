---
layout: post
title: "스트라드비젼(STRADVISION) - Data AI Engineer"
date: 2026-06-15
company: "스트라드비젼(STRADVISION)"
...
`Data AI` `Computer Vision` `Deep Learning` `Autonomous Driving` `AI Pipeline` `Data Engineering` `SVNet` `Perception AI` `Camera Recognition` `Machine Learning`

---

## 공고 요약

스트라드비젼은 AI 기반 카메라 인식 기술을 개발하는 자율주행 소프트웨어 기업으로, 서울 오피스에서 근무할 Data AI Engineer를 채용합니다. Vision Perception AI 기술 개발을 위한 데이터 파이프라인 및 AI 엔지니어링 역량을 갖춘 인재를 찾고 있습니다. 전 세계 8개 오피스, 300명 이상 규모의 글로벌 기업으로 자율주행 분야에서 다수의 글로벌 인증 및 수상 실적을 보유하고 있습니다.

---

## 필수 지원 조건

- AI/ML 데이터 파이프라인 설계 및 구축 경험
- 딥러닝 및 컴퓨터 비전 관련 기술 이해
- 데이터 엔지니어링 및 대용량 데이터 처리 능력

---

## 추천 대상

- 자율주행 또는 Vision AI 분야에 관심 있는 개발자
- 데이터 파이프라인 및 AI 인프라 구축 경험자
- 글로벌 환경에서 AI 제품 개발에 참여하고 싶은 엔지니어
