---
layout: post
title: "mongodb - Senior Engineering Manager, Storage Execution (RSS)"
date: 2026-06-15
company: "mongodb"
role: "Senior Engineering Manager, Storage Execution (RSS)"
location: "New York"
source: "greenhouse"
...
`Engineering Manager` `Storage Engine` `Distributed Systems` `MongoDB` `Replication` `Transactions` `Cloud-Native` `Database Internals` `Leadership` `RSS`

---

## 공고 요약

MongoDB는 뉴욕 기반의 Storage Execution 팀을 이끌 시니어 엔지니어링 매니저를 채용합니다. 이 팀은 MongoDB의 핵심 트랜잭션 읽기/쓰기 경로와 차세대 클라우드 네이티브 스토리지 아키텍처를 담당합니다. 미션 크리티컬 프로덕션 워크로드의 정확성과 성능을 책임지는 역할로, 고객 데이터의 영구 저장에 대한 강한 책임감을 요구합니다. 팀원과 사용자 모두에 대한 공감 능력과 함께 기술적 깊이를 갖춘 핸즈온 리더십이 핵심입니다.

---

## 필수 지원 조건

- 스토리지 엔진, 분산 시스템 또는 데이터베이스 내부 구조에 대한 깊은 기술적 이해
- 엔지니어링 팀을 직접 관리한 리더십 경험
- 트랜잭션, 내구성, 복제 등 시스템 수준의 개념에 대한 실무 지식
- 고객 성공 및 프로덕션 워크로드 품질에 대한 강한 책임감

---

## 추천 대상

- 데이터베이스 스토리지 엔진 또는 분산 시스템 분야의 기술 리더 경험자
- 엔지니어링 매니저로서 핸즈온 방식의 기술적 리더십을 추구하는 사람
- 미션 크리티컬 시스템의 안정성과 성능 최적화에 열정이 있는 사람
- 클라우드 네이티브 아키텍처 전환 프로젝트에 관심 있는 시니어 엔지니어
