---
layout: post
title: "databricks - Senior Machine Learning Engineer - GenAI Platform "
date: 2026-06-13
company: "databricks"
role: "Senior Machine Learning Engineer - GenAI Platform "
...
`Machine Learning` `GenAI` `LLM` `Fine-tuning` `Model Training` `Databricks` `Transformer` `AI Platform` `MLOps` `Cloud Infrastructure`

---

## 공고 요약

Databricks 산하의 Mosaic AI에서 GenAI 플랫폼을 담당할 시니어 머신러닝 엔지니어를 채용합니다. 이 팀은 기업이 자체 데이터로 AI 모델을 안전하게 파인튜닝, 학습, 배포할 수 있는 플랫폼을 개발합니다. 오픈소스 LLM 분야에서 이미 300만 다운로드 이상의 성과를 보유한 팀으로, 실질적인 대규모 AI 모델 개발 경험을 쌓을 수 있는 환경입니다. 의료, 교통 등 다양한 산업의 난제를 AI로 해결하는 것을 목표로 합니다.

---

## 필수 지원 조건

- 대규모 언어 모델(LLM) 학습 및 파인튜닝 실무 경험
- 클라우드 환경(AWS/GCP/Azure)에서의 ML 모델 배포 및 운영 경험
- 머신러닝 플랫폼 또는 MLOps 파이프라인 개발 경험
- Transformer 아키텍처 및 딥러닝 프레임워크(PyTorch 등) 활용 능력

---

## 추천 대상

- LLM 또는 생성형 AI 플랫폼 개발에 깊은 관심을 가진 ML 엔지니어
- 오픈소스 AI 생태계에 기여하고 싶은 개발자
- 대규모 분산 학습 시스템 구축 경험이 있는 엔지니어
- Databricks 또는 데이터/AI 플랫폼 환경에서 일하고 싶은 분
