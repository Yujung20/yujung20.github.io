---
layout: post
title: "scaleai - [Annotations] Operations Program Manager"
date: 2026-06-15
company: "scaleai"
...
`Operations Program Manager` `Robotics` `Machine Learning` `Data Annotation` `Training Data` `Process Improvement` `Cross-functional Leadership` `Autonomous Systems` `Pilot Execution` `Scale AI`

---

## 공고 요약

Scale AI는 로보틱스 AI 모델을 위한 고품질 훈련 데이터 생성을 이끌 운영 프로그램 매니저를 멕시코시티에서 채용합니다. 이 역할은 로봇의 인식, 조작, 자율 의사결정을 지원하는 데이터셋의 정확하고 신속한 납품을 책임집니다. 파일럿 실행, 프로세스 설계, 운영 최적화를 통해 고객 만족과 제품 혁신을 동시에 달성해야 합니다. 빠르게 성장하는 환경에서 전략적 판단과 실행력을 겸비한 인재를 찾고 있습니다.

---

## 필수 지원 조건

- 운영 프로그램 관리 또는 데이터 운영 관련 실무 경험
- 머신러닝 또는 로보틱스 데이터 파이프라인에 대한 이해
- 파일럿/실험 설계 및 프로세스 개선 역량
- 다기능 팀(Cross-functional)과의 협업 및 리더십 경험

---

## 추천 대상

- 데이터 어노테이션 또는 AI 훈련 데이터 운영 경험이 있는 분
- 로보틱스 또는 자율주행 관련 프로젝트를 관리해본 분
- 빠르게 변화하는 스타트업 환경에서 실행력을 발휘한 경험이 있는 분
- 운영 효율화와 고객 납기 관리를 동시에 해본 프로그램 매니저
