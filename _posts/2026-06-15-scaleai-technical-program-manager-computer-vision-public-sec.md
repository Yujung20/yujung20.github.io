---
layout: post
title: "scaleai - Technical Program Manager (Computer Vision), Public Sector"
date: 2026-06-15
company: "scaleai"
role: "Technical Program Manager (Computer Vision), Public Sector"
...
`Technical Program Manager` `Computer Vision` `Public Sector` `National Security` `AI` `Enterprise Solutions` `Cross-functional Team` `Customer Relationship Management` `Data Analytics` `Scale AI`

---

## 공고 요약

Scale AI는 미국 정부의 국가 안보 미션에 AI를 적용하는 최전선 기업으로, 공공부문 고객을 위한 컴퓨터 비전 워크플로우를 이끌 Technical Program Manager를 채용합니다. 이 역할은 국가 안보 고객과의 관계를 경영진부터 실무자까지 전방위로 관리하며, 컴퓨터 비전 유즈케이스 기획 및 엔지니어링팀과의 협업을 주도합니다. 데이터와 분석을 활용해 내부 리소스를 조율하고 고객에게 직접적인 가치를 제공하는 도구 개발을 이끄는 역할입니다.

---

## 필수 지원 조건

- 컴퓨터 비전 또는 AI 관련 기술 프로그램 관리 경험
- 고객 관계 관리 및 크로스펑셔널 팀 리딩 경험
- 미국 정부 또는 국가 안보 관련 공공부문 업무 경험 (보안 허가 우대)
- 데이터 및 분석을 활용한 프로젝트 조율 능력
- 기술적 이슈 트리아지 및 엔지니어링팀과의 협업 능력

---

## 추천 대상

- 국방·공공부문 AI/컴퓨터 비전 프로젝트 경험이 있는 TPM
- 미국 정부 고객과의 협업 또는 보안 허가 보유자
- 기술과 비즈니스를 연결하는 역할에 관심 있는 엔지니어링 배경 보유자
- 엔터프라이즈 고객 대상 복잡한 기술 솔루션 납품 경험자
- 워싱턴 D.C. 지역 거주 또는 이전 가능한 지원자
