---
layout: post
title: "singlestore - Staff Product Manager | Cloud Data Platform"
date: 2026-06-13
company: "singlestore"
role: "Staff Product Manager | Cloud Data Platform"
...
`Product Manager` `Cloud Data Platform` `AI Infrastructure` `SaaS` `Enterprise Cloud` `Scalability` `Reliability` `Developer Experience` `Roadmap` `Data Platform`

---

## 공고 요약

SingleStore는 차세대 AI 및 엔터프라이즈 애플리케이션을 지원하는 실시간 데이터 플랫폼을 구축하는 회사입니다. Staff Product Manager로서 클라우드 서비스 플랫폼의 핵심 영역을 이끌며, 인프라·신뢰성·확장성·보안·개발자 경험 등 클라우드 플랫폼 전반의 로드맵을 정의하고 주도하는 역할입니다. 엔지니어링, 디자인, 영업팀 및 고객과 긴밀히 협력하여 엔터프라이즈 고객을 위한 고임팩트 클라우드 플랫폼 기능을 제공하는 시니어급 포지션입니다.

---

## 필수 지원 조건

- 클라우드 데이터 플랫폼 또는 인프라 관련 제품 관리 경험
- 엔터프라이즈 SaaS 또는 클라우드 서비스 제품 로드맵 정의 및 실행 경험
- 엔지니어링 및 디자인 팀과의 긴밀한 협업 및 커뮤니케이션 능력
- 고객 니즈, 시장 트렌드, 경쟁사 분석을 제품 전략으로 전환하는 역량

---

## 추천 대상

- 클라우드 인프라 또는 데이터 플랫폼 분야에서 시니어/스태프급 PM 경험을 가진 분
- AI·데이터 워크로드의 확장성과 신뢰성 문제에 관심이 많은 기술적 배경의 PM
- 엔터프라이즈 고객을 대상으로 한 글로벌 클라우드 서비스 기획 경험이 있는 분
- 빠르게 성장하는 스타트업 환경에서 제품 방향성을 주도적으로 이끌고 싶은 분
