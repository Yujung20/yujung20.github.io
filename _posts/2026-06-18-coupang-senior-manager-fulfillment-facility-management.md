---
layout: post
title: "coupang - Senior Manager, Fulfillment Facility Management"
date: 2026-06-18
company: "coupang"
role: "Senior Manager, Fulfillment Facility Management"
...
`Facility Management` `Fulfillment Center` `Preventive Maintenance` `Predictive Maintenance` `KPI Tracking` `Data Analytics` `Vendor Management` `Operations Excellence` `Team Leadership` `Continuous Improvement`

---

## 공고 요약

쿠팡 대만 법인에서 타오위안 지역 풀필먼트 센터의 시설 유지보수를 총괄할 시니어 매니저를 채용합니다. 설비 가동률 극대화, 예방/예측 유지보수 전략 수립, 시설 관련 KPI 관리 등 운영 전반을 책임지는 역할입니다. 시설 유지보수 팀(엔지니어 및 기술자)을 직접 리드하며 데이터 기반의 의사결정으로 지속적인 운영 개선을 이끌어야 합니다. 공급업체 관리 및 시설 확장·업그레이드 프로젝트도 담당하며, 안전 법규 및 회사 정책 준수도 핵심 책임 중 하나입니다.

---

## 필수 지원 조건

- 풀필먼트 센터 또는 대규모 물류/제조 시설의 유지보수 관리 경험
- 예방적·예측적 유지보수 전략 수립 및 실행 경험
- 시설 관련 KPI 설정, 데이터 분석 및 성과 추적 역량
- 시설 유지보수 팀 리더십 및 인재 육성 경험
- 공급업체 관리 및 시설 확장/인프라 개선 프로젝트 수행 경험

---

## 추천 대상

- 대형 물류센터 또는 제조 공장에서 시설/설비 관리 팀장 이상 경력을 보유한 분
- 데이터 기반 운영 개선(Operational Excellence) 경험이 있는 분
- 다국적 기업 환경에서 팀을 이끌고 조직 문화를 구축한 경험이 있는 분
- 빠르게 성장하는 이커머스·물류 환경에서 일하고 싶은 분
- 중국어(번체) 사용 환경에 익숙하고 대만에서 근무 가능한 분
