---
layout: post
title: "Plain - Founding-Data-Engineer"
date: 2026-05-28
categories: [jobs]
tags: [linkedin, plain, founding-data-engineer]
---
...
- 현대적인 분석 스택(데이터 웨어하우스, 변환, 시맨틱 레이어, 거버넌스)을 처음부터 끝까지 구축한 경험 (가능하면 2회 이상)
- SQL, BigQuery, dbt/Dataform에 대한 강력한 역량
- Tinybird, ClickHouse 등 실시간 데이터 플랫폼을 활용한 사용자 대면 분석 또는 AI 검색 레이어 구축 경험
- 데이터 품질, 신뢰성, 재사용성에 대한 높은 관심
- 명확한 커뮤니케이션 능력 및 복잡한 프로세스 없이 팀 간 합의를 이끌어내는 능력
- 자기 주도적이며 결과물의 영향력을 기준으로 업무를 평가하는 태도

---

## 추천 대상

데이터 웨어하우스 설계부터 파이프라인 구축, 인앱 리포팅까지 데이터 엔지니어링 전반을 직접 소유하고 싶은 분에게 적합합니다. 빠르게 성장하는 B2B SaaS 스타트업에서 데이터 인프라를 처음부터 구축하는 경험을 원하며, 모호한 환경과 그린필드 프로젝트에 익숙한 분께 추천합니다. AI 기능의 데이터 레이어를 직접 설계하고, 장기적으로 데이터 조직 전체를 이끌어갈 성장 기회를 원하는 시니어 개인 기여자(IC)에게 이상적인 포지션입니다.
