---
layout: post
title: "Lyft - Data-Engineer-Mapping"
date: 2026-05-28
categories: [jobs]
tags: [linkedin, lyft, data-engineer-mapping]
---
...
- 컴퓨터 과학, 공학, 수학, 통계 또는 관련 분야 학사 학위
- 4년 이상의 관련 실무 경험
- Spark 및 스크립팅 언어(Python, Ruby, Bash) 강한 활용 능력
- 데이터 품질 문제에 대한 깊은 이해와 복잡한 데이터셋의 불일치를 해결할 수 있는 뛰어난 분석 능력
- 기술적/비기술적 청중 모두에게 기술 개념을 명확히 전달할 수 있는 우수한 커뮤니케이션 능력
- S3, DynamoDB, HDFS, Hive, Presto, Pig, HBase, Parquet, Iceberg, Flink, Spark Streaming, Kafka 등 다양한 데이터베이스, 쿼리 및 스트리밍 기술 경험
- Great Expectations, dbt, Monte Carlo, Soda, Collibra 등 데이터 품질 도구 사용 경험
- SQL 엔진에 대한 깊은 이해, 지리공간 데이터 쿼리 경험 및 고급 성능 튜닝 능력
- MySQL, PostgreSQL, SqlServer, Oracle 중 하나 이상의 SQL 언어에 대한 숙련도
- Airflow, Oozie, Azkaban, UC4, Prefect 등 워크플로우 관리 도구 사용 경험
- Terraform, Cloud Formation, Docker, Kubernetes, Ansible, Chef, Puppet 등 인프라 도구 사용 경험 (AWS 환경 우대)
- API 스키마 정의 및 마이크로서비스 환경에서의 백엔드 서비스 개발 경험

---

## 추천 대상

대규모 데이터 파이프라인 설계 및 운영 경험이 있으며, Spark와 클라우드 기반 데이터 인프라(AWS)에 능숙한 데이터 엔지니어에게 적합합니다. 지리공간 데이터 처리나 매핑 관련 도메인에 관심이 있는 분, 또는 ETL 파이프라인 최적화 및 데이터 품질 관리 경험이 풍부한 분께 추천드립니다. 머신러닝 팀 및 데이터 사이언티스트와의 긴밀한 협업을 즐기며, 수백만 명의 라이더와 드라이버에게 직접적인 영향을 미치는 프로젝트에서 임팩트를 내고 싶은 분께 특히 적합합니다. 토론토 지역 거주자이거나 주 3일 이상 오피스 출근이 가능한 하이브리드 근무를 선호하는 분께도 좋은 기회입니다.
