---
layout: post
title: "stripe - Backend Engineer, Privy"
date: 2026-06-15
company: "stripe"
role: "Backend Engineer, Privy"
location: "NYC-Privy"
source: "greenhouse"
...
`Backend Engineer` `Crypto` `Blockchain` `API Development` `Web3` `Wallet Infrastructure` `Privacy` `Distributed Systems` `Stripe` `Fintech`

---

## 공고 요약

Stripe가 인수한 Privy는 프라이버시와 사용자 소유권을 기본값으로 만드는 미션을 가진 팀입니다. 개발자를 위한 크립토 기반 API와 툴을 만들며, 지갑 추상화 및 인프라 레이어를 구축합니다. Ramp, Klarna, Kraken 등 주요 고객사를 보유하며 빠른 이터레이션과 보안 중심의 엔지니어링 문화를 추구합니다. 백엔드 엔지니어로서 PM 역할까지 겸하는 주도적인 인재를 찾고 있습니다.

---

## 필수 지원 조건

- 백엔드 시스템 설계 및 API 개발 경험
- 보안 및 암호화 관련 기술 지식
- 크립토/블록체인 관련 기술 이해 또는 경험
- 빠른 속도의 스타트업 환경에서의 개발 경험

---

## 추천 대상

- 크립토/Web3 인프라에 관심 있는 백엔드 개발자
- 보안과 프라이버시 기술에 열정이 있는 엔지니어
- PM 없이 제품 방향을 스스로 결정하고 싶은 개발자
- Stripe 같은 글로벌 핀테크 생태계에서 일하고 싶은 분
