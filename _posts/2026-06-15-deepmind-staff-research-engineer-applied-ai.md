---
layout: post
title: "deepmind - Staff Research Engineer, Applied AI "
date: 2026-06-15
company: "deepmind"
role: "Staff Research Engineer, Applied AI "
location: "Singapore "
source: "greenhouse"
...
`Generative AI` `Research Engineering` `Applied AI` `Software Development` `GenAI` `Google DeepMind` `AI Deployment` `Product Development` `Machine Learning` `Scalable Systems`

---

## 공고 요약

Google DeepMind의 싱가포르 오피스에서 최신 생성형 AI 모델을 활용한 실제 애플리케이션 개발 및 배포를 이끌 Staff Research Engineer를 찾고 있습니다. 이 역할은 최첨단 AI 연구를 실제 제품으로 전환하고 Google 및 주요 고객사에 임팩트를 제공하는 데 초점을 맞춥니다. 초기 단계 환경에서 제품을 개념부터 프로덕션까지 스케일링한 경험이 있는 엔지니어를 선호하며, 강력한 소프트웨어 엔지니어링 역량과 GenAI 도구에 대한 열정이 요구됩니다.

---

## 필수 지원 조건

- 소프트웨어 개발 및 제품 출시(shipping)에 대한 강력한 실적 보유
- 생성형 AI(GenAI) 모델 및 도구 활용 경험
- 초기 단계 환경에서 제품을 프로덕션까지 스케일링한 경험
- 파트너 팀과의 협업 및 크로스펑셔널 커뮤니케이션 능력
- 강력한 소프트웨어 엔지니어링 기초 역량

---

## 추천 대상

- AI/ML 연구 결과를 실제 제품으로 구현한 경험이 있는 엔지니어
- 스타트업 또는 초기 단계 프로젝트에서 0→1 제품 개발을 경험한 개발자
- 비즈니스 임팩트와 기술적 도전 모두에 관심 있는 Applied AI 엔지니어
- Google 또는 대형 테크 기업의 AI 솔루션을 엔터프라이즈에 적용해보고 싶은 분
- 싱가포르 기반으로 아시아 태평양 지역에서 커리어를 쌓고자 하는 시니어 엔지니어
