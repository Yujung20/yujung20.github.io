---
layout: post
title: "Jobright - Data-Engineer"
date: 2026-05-28
categories: [jobs]
tags: [linkedin, jobright, data-engineer]
---
...
- 컴퓨터 공학, 데이터 엔지니어링 또는 관련 기술 분야 학위를 보유한 신입 또는 초급 전문가 (0~2년 경력)
- Python 및 SQL에 대한 높은 숙련도와 데이터 변환 로직 작성 및 디버깅 실무 경험
- 데이터 모델링, 데이터 웨어하우스 설계 패턴, 배치 및 스트리밍 아키텍처 간의 트레이드오프에 대한 실질적인 이해
- API, 버전 관리(Git), 테스트 가능한 프로덕션 수준의 코드 작성 등 탄탄한 소프트웨어 엔지니어링 기초 역량

---

## 추천 대상

데이터 엔지니어링 분야에 막 입문하거나 관련 학위를 최근 취득한 신입 개발자에게 적합한 포지션입니다. Python과 SQL 역량을 갖추고 있으며, ETL/ELT 파이프라인 설계 및 데이터 품질 관리에 관심 있는 구직자에게 추천합니다. AI 기반 프로덕트 환경에서 높은 자율성과 책임감을 가지고 실무 경험을 쌓고 싶은 분, 특히 데이터가 제품 의사결정에 미치는 영향에 관심 있는 분께 좋은 기회가 될 것입니다.
