---
layout: post
title: "databricks - Specialist Solutions Architect - Data Engineering & Warehousing"
date: 2026-06-13
company: "databricks"
role: "Specialist Solutions Architect - Data Engineering & Warehousing"
...
`Data Engineering` `Data Warehousing` `Lakehouse Architecture` `Databricks` `Cloud Data Platform` `Business Intelligence` `Solutions Architect` `Apache Spark` `ETL` `SQL`

---

## 공고 요약

Databricks는 데이터 엔지니어링 및 웨어하우징 분야의 Specialist Solutions Architect를 채용합니다. 이 역할은 고객이 클라우드 데이터 엔지니어링 및 웨어하우징 전환을 성공적으로 수행할 수 있도록 기술적 리더십을 제공합니다. 고객 대면 역할로서 Solutions Architect팀과 협력하며 Databricks Data Intelligence Platform 기반의 기술 로드맵을 수립합니다. 대규모 데이터 웨어하우징 기술과 레이크하우스 아키텍처에 대한 실무 경험이 필수적으로 요구됩니다.

---

## 필수 지원 조건

- 대규모 데이터 웨어하우징 기술에 대한 실무 프로덕션 경험
- 클라우드 데이터 엔지니어링 및 레이크하우스 아키텍처 전문 지식
- 고객 대면 기술 컨설팅 및 솔루션 아키텍처 설계 경험
- 비즈니스 인텔리전스 워크로드 평가 및 프로덕션 계획 수립 능력

---

## 추천 대상

- 데이터 엔지니어링 및 클라우드 데이터 플랫폼 분야에서 5년 이상 경력을 보유한 전문가
- Databricks, Snowflake, Redshift 등 대규모 데이터 웨어하우징 플랫폼 경험자
- 고객사 기술 컨설팅 또는 프리세일즈 엔지니어링 경험이 있는 분
- 레이크하우스 아키텍처 및 BI 솔루션 설계에 관심 있는 데이터 아키텍트
