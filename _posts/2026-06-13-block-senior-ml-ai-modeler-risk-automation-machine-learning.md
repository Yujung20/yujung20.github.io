---
layout: post
title: "block - Senior ML/AI Modeler, Risk Automation Machine Learning"
date: 2026-06-13
company: "block"
role: "Senior ML/AI Modeler, Risk Automation Machine Learning"
...
`Machine Learning` `Generative AI` `Agentic AI` `Risk Automation` `NLP` `Python` `Deep Learning` `Compliance` `MLOps` `Financial Services`

---

## 공고 요약

Block(Square, Cash App 등 운영)의 Risk Automation ML팀에서 Senior ML/AI Modeler를 채용합니다. 이 역할은 리스크 및 컴플라이언스 조사와 의사결정을 자동화하기 위해 Agentic AI 및 생성형 AI 기술을 적용하는 업무를 담당합니다. Product, Engineering, Operations 팀과 글로벌하게 협업하며 안전한 사용자 경험을 제공하는 데 기여합니다. 금융 서비스 환경에서 머신러닝 모델을 설계하고 배포할 수 있는 시니어급 전문가를 찾고 있습니다.

---

## 필수 지원 조건

- 머신러닝/딥러닝 모델 설계 및 프로덕션 배포 경험 (시니어급)
- 생성형 AI 및 Agentic AI 기술에 대한 실무 경험
- 리스크, 컴플라이언스 또는 금융 서비스 도메인 관련 ML 적용 경험
- Python 등 ML 관련 프로그래밍 언어 능숙
- 크로스펑셔널 팀(Product, Engineering, Operations)과의 협업 능력

---

## 추천 대상

- 금융/핀테크 도메인에서 리스크 탐지 또는 이상 감지 ML 모델을 개발한 경험이 있는 분
- LLM 기반 에이전트 시스템 또는 생성형 AI 파이프라인 구축 경험이 있는 분
- 대규모 데이터 환경에서 ML 모델을 설계하고 운영(MLOps)한 시니어 엔지니어
- 컴플라이언스 자동화 또는 RegTech 분야에 관심 있는 AI/ML 전문가
- 글로벌 팀과 협업하며 임팩트 있는 AI 솔루션을 만들고 싶은 분
