---
layout: post
title: "deepmind - Manager, Applied AI Engineering"
date: 2026-06-16
company: "deepmind"
role: "Manager, Applied AI Engineering"
location: "London, UK"
source: "greenhouse"
...
`Applied AI` `Generative AI` `Engineering Manager` `Google DeepMind` `AI Deployment` `Software Engineering` `Team Leadership` `Product Development`

---

## 공고 요약

Google DeepMind는 런던에서 Applied AI Engineering 매니저를 채용합니다. 이 역할은 Google의 생성형 AI 모델을 활용한 신규 애플리케이션 개발 및 배포를 이끌며, 최신 AI 연구를 실제 제품으로 전환하는 것을 목표로 합니다. 파트너 팀과 협력하여 Google 및 주요 고객에게 솔루션을 제공하고 비즈니스 임팩트를 극대화하는 역할을 담당합니다. 초기 단계 환경에서의 경험을 바탕으로 제품을 스케일업한 경험이 있는 리더를 찾고 있습니다.

---

## 필수 지원 조건

- 소프트웨어 개발 및 출시(shipping)에 대한 강력한 실적 보유
- 엔지니어링 팀 리딩 경험
- 초기 단계(early-stage) 환경에서 제품을 컨셉에서 프로덕션까지 스케일업한 경험
- 생성형 AI 또는 최신 AI 모델 관련 기술 이해
...
- AI/ML 제품을 실제 서비스로 출시한 경험이 있는 엔지니어링 매니저
- 스타트업 또는 초기 단계 팀에서 제품을 빠르게 성장시킨 경험이 있는 리더
- AI 연구팀과 협업하여 연구 결과를 제품화한 경험이 있는 분
- 비즈니스 임팩트와 기술적 실행력을 동시에 추구하는 테크 리더
- Google 또는 대형 테크 기업의 엔터프라이즈 고객 솔루션에 관심 있는 분
