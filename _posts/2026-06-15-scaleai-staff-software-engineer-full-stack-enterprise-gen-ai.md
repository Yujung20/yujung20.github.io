---
layout: post
title: "scaleai - Staff Software Engineer, Full-Stack - Enterprise Gen AI"
date: 2026-06-15
company: "scaleai"
role: "Staff Software Engineer, Full-Stack - Enterprise Gen AI"
...
`Full-Stack` `Frontend` `React` `TypeScript` `Gen AI` `Enterprise SaaS` `AI Platform` `API Integration` `UI/UX` `LLM`

---

## 공고 요약

Scale AI의 Generative AI Platform(SGP) 팀에서 엔터프라이즈급 AI 애플리케이션을 구축할 프론트엔드 중심 풀스택 엔지니어를 채용합니다. 고객 대면 AI 앱과 내부 SaaS 제품 개발을 담당하며, TIME의 올해의 인물 AI 경험 같은 혁신적 프로젝트에 참여합니다. 빠르게 변화하는 환경에서 다양한 프로젝트를 소화하고 높은 품질의 직관적인 UX를 구현하는 데 열정 있는 인재를 찾고 있습니다.

---

## 필수 지원 조건

- 프론트엔드 중심의 풀스택 개발 경험 (React, TypeScript 등)
- 엔터프라이즈 SaaS 또는 AI 플랫폼 개발 경험
- API 설계 및 통합 경험 (지식 검색, 추론, 평가 등)
- 빠른 속도의 환경에서 다양한 프로젝트를 병행 처리할 수 있는 역량

---

## 추천 대상

- 프론트엔드에 강점을 가진 풀스택 엔지니어로 AI 제품 개발에 관심 있는 분
- LLM 기반 AI 애플리케이션 및 에이전트 시스템 구축 경험이 있는 분
- 사용자 경험(UX) 품질에 높은 기준을 가지고 있는 분
- 빠른 성장 환경에서 다양한 도메인의 프로젝트를 즐기는 분
