---
layout: post
title: "deepmind - Research Scientist, Gemini Safety"
date: 2026-06-16
company: "deepmind"
role: "Research Scientist, Gemini Safety"
...
`AI Safety` `Machine Learning` `Gemini` `Research Scientist` `Deep Learning` `Fairness` `LLM` `Reinforcement Learning` `Data Science` `Google DeepMind`

---

## 공고 요약

Google DeepMind의 Gemini Safety 팀에서 AI 안전성 및 공정성을 담당할 Research Scientist를 채용합니다. 최신 Gemini 모델의 안전하고 공정한 동작을 보장하기 위한 데이터 및 알고리즘 솔루션을 개발하는 역할입니다. 빠른 속도의 협업 중심 환경에서 최첨단 AI 기술을 연구하며, 안전성과 윤리를 최우선으로 하는 팀 문화를 가지고 있습니다.

---

## 필수 지원 조건

- 머신러닝 및 AI 분야의 연구 경험 보유
- AI 안전성, 공정성 관련 알고리즘 개발 역량
- 대규모 언어 모델(LLM) 또는 최신 AI 모델에 대한 깊은 이해
- 데이터 기반 솔루션 설계 및 구현 능력

---

## 추천 대상

- AI 안전성(AI Safety) 및 윤리 연구에 관심 있는 연구자
- LLM 또는 대형 AI 모델 관련 경험을 보유한 머신러닝 엔지니어
- 빠른 속도의 협업 환경에서 연구개발을 즐기는 사람
- Google DeepMind와 같은 최전선 AI 연구 기관에서 임팩트 있는 연구를 원하는 사람
