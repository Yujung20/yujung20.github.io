---
layout: post
title: "scaleai - Machine Learning Fellow - Human Frontier Collective (US)"
date: 2026-06-13
company: "scaleai"
role: "Machine Learning Fellow - Human Frontier Collective (US)"
...
`Machine Learning` `PyTorch` `Deep Learning` `Generative AI` `AI Evaluation` `1099 Contractor` `Remote` `NLP` `Model Optimization` `Research`

---

## 공고 요약

Scale AI의 Human Frontier Collective(HFC) 펠로우십은 AI 연구자 및 도메인 전문가를 모집하는 6개월 원격 계약직 프로그램입니다. 선발된 펠로우는 파트너 AI 연구소 및 플랫폼과 협력하여 고영향력 ML 프로젝트에 참여하게 됩니다. 주요 업무는 PyTorch 모델 설계·검토·최적화, 복잡한 ML 코드 평가, 생성형 AI 시스템 해석 등입니다. 학문적·실무적 전문성을 바탕으로 최첨단 AI 연구에 기여하며 학제간 네트워크와 협업할 수 있는 기회입니다.

---

## 필수 지원 조건

- 미국 내 취업 가능 신분 보유 (비자 스폰서십 불가)
- PyTorch를 활용한 딥러닝 모델 설계 및 최적화 실무 경험
- ML 코드 및 생성형 AI 시스템 평가 능력
- 독립 계약자(1099) 형태의 원격 근무 가능 여부
- 관련 분야 학술 또는 전문 연구 경험

---

## 추천 대상

- 딥러닝/머신러닝 분야 박사과정생 또는 연구원
- PyTorch 기반 모델 개발 경험이 풍부한 ML 엔지니어
- 생성형 AI 평가 및 해석 연구에 관심 있는 전문가
- 유연한 원격 계약 형태로 최첨단 AI 프로젝트에 참여하고 싶은 연구자
- AI 연구소와의 협업 및 네트워킹 기회를 원하는 학계 전문가
