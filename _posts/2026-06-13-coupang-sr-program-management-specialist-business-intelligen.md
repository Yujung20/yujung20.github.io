---
layout: post
title: "coupang - Sr.  Program Management Specialist (Business Intelligence)"
date: 2026-06-13
company: "coupang"
role: "Sr.  Program Management Specialist (Business Intelligence)"
...
`Business Intelligence` `Program Management` `Data Analysis` `Customer Insights` `Risk Management` `Business Analytics` `Planning` `E-commerce`

---

## 공고 요약

쿠팡 대만 법인에서 고객 중심 기획팀(Customer-Centric Planning)의 시니어 비즈니스 애널리스트를 채용합니다. 대만 로켓배송 및 로켓직구 서비스의 성장을 지원하며, 고객 인사이트 분석과 리스크/기회 관리를 담당합니다. 빠른 의사결정을 지원하는 데이터 기반 분석 역량이 핵심 요구사항입니다. 쿠팡의 대만 시장 확장을 이끌 핵심 인재를 찾고 있습니다.

---

## 필수 지원 조건

- 비즈니스 인텔리전스 및 데이터 분석 실무 경험
- 프로그램/프로젝트 관리 역량
- 고객 인사이트 분석 및 리스크 관리 경험
- 이커머스 또는 유통 업종 관련 경험
...
- 데이터 기반 의사결정 및 BI 분석 경험이 있는 분
- 이커머스 또는 물류 플랫폼에서 기획/분석 업무를 해온 분
- 빠르게 성장하는 스타트업 환경에서 일하고 싶은 분
- 대만 또는 글로벌 시장에서 커리어를 쌓고 싶은 분
