---
layout: post
title: "databricks - Staff Product Designer, AI Products "
date: 2026-06-15
company: "databricks"
role: "Staff Product Designer, AI Products "
...
`Product Design` `AI Products` `Agent-driven UX` `0-to-1` `Data Platform` `Lakehouse` `Systems Thinking` `UX Design` `Databricks` `Staff Designer`

---

## 공고 요약

Databricks는 AI 기반 신규 제품 카테고리를 구축할 Staff Product Designer를 뉴욕에서 채용합니다. 이 역할은 에이전트 기반 워크플로우를 설계하여 Lakehouse의 기능을 더 넓은 사용자층에 제공하는 것을 목표로 합니다. 완전한 0-to-1 환경에서 전략적 신제품 영역의 핵심 디자인 이니셔티브를 주도하게 됩니다. 스타트업의 역동성과 대형 테크 기업의 리소스를 동시에 경험할 수 있는 포지션입니다.

---

## 필수 지원 조건

- 복잡한 데이터 워크플로우를 직관적인 UX로 전환한 시니어급 이상의 프로덕트 디자인 경험
- 에이전트 또는 AI 기반 제품의 0-to-1 설계 경험
- 비주얼 크래프트와 시스템 씽킹을 겸비한 디자인 역량
- 데이터 플랫폼 또는 엔터프라이즈 SaaS 제품 디자인 경험

---

## 추천 대상

- AI/에이전트 기반 제품의 UX를 처음부터 설계해본 경험이 있는 디자이너
- 데이터 분석 또는 데이터 엔지니어링 도구 디자인에 관심 있는 시니어 디자이너
- 스타트업 수준의 오너십과 대기업 리소스를 동시에 원하는 디자이너
- 복잡한 엔터프라이즈 워크플로우를 단순화하는 데 열정 있는 Staff/Principal급 디자이너
