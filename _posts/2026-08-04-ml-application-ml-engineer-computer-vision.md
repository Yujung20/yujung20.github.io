---
layout: post
title: "지신 - [ML Application] ML Engineer (Computer Vision)"
date: 2026-08-04
company: "지신"
role: "[ML Application] ML Engineer (Computer Vision)"
location: "서울"
source: "wanted"
link: "https://www.wanted.co.kr/wd/378713"
---
 
## 링크
 
https://www.wanted.co.kr/wd/378713
...
`Computer Vision` `ML Engineering` `Deep Learning` `Anomaly Detection` `Time-series Forecasting` `LLM` `Reinforcement Learning` `Manufacturing AI` `Model Deployment` `Edge AI`

---

## 공고 요약

지신은 Enterprise AI 플랫폼 Apex OS를 개발하는 스타트업으로, 제조 현장(자동차부품, 철강, 전자)에 실제 동작하는 AI 솔루션을 구축하는 ML Engineer를 채용합니다. Computer Vision을 중심으로 하드웨어 연동부터 모델 배포·운영까지 전 과정을 담당하며, 고객과 가장 가까운 곳에서 문제 정의부터 실행까지 책임지는 역할입니다. 연구보다는 현장 문제 해결에 집중하는 실전형 엔지니어를 찾고 있습니다.

---

## 필수 지원 조건

- Computer Vision 모델 개발 및 실무 적용 경험
- ML 모델의 배포 및 운영(MLOps) 경험
- 제조 현장 또는 산업 AI 프로젝트 경험
- 문제 정의부터 모델링, 배포까지 End-to-End 수행 능력

---

## 추천 대상

- 제조·산업 현장에서 AI를 실제로 적용해본 경험이 있는 분
- 연구보다 실제 비즈니스 임팩트 창출에 더 큰 보람을 느끼는 분
- 빠른 성장 환경과 높은 자율성을 선호하는 초기 스타트업 선호자
- Computer Vision 외 다양한 AI 기술(이상탐지, 예측, LLM 등)을 함께 다루고 싶은 분
