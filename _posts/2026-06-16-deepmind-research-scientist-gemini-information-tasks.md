---
layout: post
title: "deepmind - Research Scientist, Gemini Information Tasks"
date: 2026-06-16
company: "deepmind"
role: "Research Scientist, Gemini Information Tasks"
...
`Post-training` `Gemini` `Information Retrieval` `Factuality` `Grounding` `LLM` `RLHF` `NLP` `Search AI` `Research Scientist`

---

## 공고 요약

DeepMind은 Gemini 모델의 정보 탐색 태스크 개선을 위한 연구 과학자를 뉴욕에서 채용합니다. 주요 업무는 포스트 트레이닝 기법을 통해 Gemini의 응답 품질, 사실성(factuality), 근거성(grounding)을 향상시키는 것입니다. 해당 연구는 AI Mode, Gemini App, AI Studio, Vertex AI 등 실제 제품에 직접 영향을 미칩니다. 정보 탐색 시나리오에서의 모델링 및 데이터 개입에 관한 근본적인 문제를 탐구하는 역할입니다.

---

## 필수 지원 조건

- LLM 포스트 트레이닝(RLHF, SFT 등) 관련 연구 경험
- 정보 검색 및 사실성(factuality) 관련 NLP 연구 경험
- 머신러닝/딥러닝 모델 개발 및 실험 설계 능력
- 관련 분야 학술 논문 게재 또는 연구 실적 보유

---

## 추천 대상

- LLM 파인튜닝 및 정렬(Alignment) 연구를 해온 연구자
- 검색 엔진 또는 질의응답(QA) 시스템 개선 경험이 있는 분
- 사실 검증(fact-checking) 또는 RAG(Retrieval-Augmented Generation) 연구자
- AI 제품에 연구를 직접 적용하고 임팩트를 내고 싶은 연구 과학자
