---
layout: post
title: "databricks - Data and AI Solution Architect (Professional Services)"
date: 2026-06-15
company: "databricks"
role: "Data and AI Solution Architect (Professional Services)"
...
`Databricks` `Data Engineering` `Data Science` `Cloud Technology` `Big Data` `Analytics` `Solution Architect` `Professional Services` `AI` `Data Platform`

---

## 공고 요약

Databricks의 Professional Services 팀에서 고객사의 빅데이터 및 AI 과제를 해결하는 Data and AI Solution Architect를 채용합니다. 단기~중기 고객 프로젝트에서 데이터 엔지니어링, 데이터 사이언스, 클라우드 기술을 활용해 Databricks 플랫폼 기반 솔루션을 제공합니다. 고객 시스템 통합, 기술 교육, 컨설팅 등 다양한 기술적 업무를 담당하며 billable 역할로 프로젝트를 주도합니다. 경험과 역량에 따라 Senior Solutions Consultant 또는 Resident Solutions Architect 타이틀로 채용될 수 있습니다.

---

## 필수 지원 조건

- Databricks 플랫폼 또는 유사 빅데이터 플랫폼 실무 경험
- 데이터 엔지니어링 및 데이터 사이언스 프로젝트 수행 능력
- 클라우드 기술(AWS, Azure, GCP 등) 활용 및 고객 시스템 통합 경험
- 고객 대면(customer-facing) 기술 컨설팅 또는 Professional Services 경험
- 프로젝트 일정과 명세에 따라 독립적으로 업무를 완수할 수 있는 역량

---

## 추천 대상

- 빅데이터 플랫폼(Spark, Databricks 등) 기반 프로젝트 경험이 있는 데이터 엔지니어 또는 아키텍트
- 고객사와 직접 협업하며 기술 솔루션을 제안·구현한 컨설팅 경험자
- 데이터 엔지니어링과 데이터 사이언스를 모두 이해하는 풀스택 데이터 전문가
- 클라우드 환경에서의 데이터 플랫폼 설계 및 구축 경험이 풍부한 엔지니어
- 기술적 깊이와 함께 고객 커뮤니케이션 능력을 갖춘 테크니컬 리드
