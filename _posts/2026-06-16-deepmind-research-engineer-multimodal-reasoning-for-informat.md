---
layout: post
title: "deepmind - Research Engineer, Multimodal Reasoning For Information Literacy"
date: 2026-06-16
company: "deepmind"
role: "Research Engineer, Multimodal Reasoning For Information Literacy"
...
`Multimodal Reasoning` `Information Literacy` `Manipulated Media Detection` `Provenance Analysis` `AI Research` `Machine Learning` `Gemini` `Deep Learning` `Computer Vision` `NLP`

---

## 공고 요약

Google DeepMind의 온라인 정보 품질 연구팀에서 멀티모달 추론 및 정보 리터러시 분야의 리서치 엔지니어를 채용합니다. 조작된 미디어 탐지, 허위 서사 분석, AI 기반 정보 리터러시 도구 개발 등 복잡한 온라인 정보 문제를 해결하는 연구를 수행합니다. 연구 성과는 Google의 주요 모델인 Gemini에 직접 반영되며, 빠른 프로토타이핑과 반복 실험을 장려하는 환경에서 다학제적 연구를 진행합니다.

---

## 필수 지원 조건

- 머신러닝 및 딥러닝 분야의 연구 경험 또는 관련 학위 보유
- 멀티모달 AI 모델(이미지, 텍스트, 영상 등) 개발 및 연구 경험
- 조작 미디어 탐지, 출처 분석 또는 정보 무결성 관련 기술 역량
- 대규모 AI 모델 연구 및 엔지니어링 경험
- Python 등 주요 ML 프레임워크(TensorFlow, PyTorch 등) 활용 능력

---

## 추천 대상

- 허위 정보 탐지 또는 미디어 포렌식 연구 경험이 있는 연구자
- 멀티모달 AI(비전-언어 모델 등) 분야에 깊은 관심과 경험을 가진 엔지니어
- 학술 연구 성과를 실제 제품에 적용한 경험이 있는 Applied Researcher
- 온라인 정보 생태계 개선 및 사회적 영향에 관심 있는 AI 연구자
- Google DeepMind 수준의 대형 연구 조직에서 협업 경험을 원하는 ML 엔지니어
