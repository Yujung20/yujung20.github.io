---
layout: post
title: "coupang - Principal II, Data Analysis & Staff Data Analyst"
date: 2026-06-13
company: "coupang"
role: "Principal II, Data Analysis & Staff Data Analyst"
...
`Data Analysis` `Data Analytics` `Principal Data Analyst` `Staff Data Analyst` `Commerce` `Retail Tech` `Data-Driven` `Business Intelligence` `SQL` `Python`

---

## 공고 요약

쿠팡은 대만 타이베이에서 Principal II 또는 Staff 레벨의 시니어 데이터 분석가를 채용합니다. 이커머스 및 리테일 산업의 성장을 데이터로 이끌 수 있는 고급 인재를 찾고 있습니다. 스타트업 문화와 대형 글로벌 상장사의 리소스를 동시에 갖춘 환경에서 커머스의 미래를 함께 만들어갈 인재를 원합니다. 빠른 성장 속도와 새로운 서비스 런칭을 데이터 기반으로 지원할 수 있는 역량이 요구됩니다.

---

## 필수 지원 조건

- 시니어 레벨(Principal/Staff)에 해당하는 데이터 분석 실무 경험
- 이커머스 또는 리테일 도메인에 대한 이해 및 분석 경험
- 데이터 기반 의사결정 및 비즈니스 문제 해결 능력
- 대규모 데이터 처리 및 분석 툴(SQL, Python 등) 활용 능력

---

## 추천 대상

- 이커머스 또는 리테일 테크 분야에서 5년 이상 데이터 분석 경험을 보유한 분
- 빠르게 성장하는 스타트업 문화에서 자기주도적으로 일하고 싶은 분
- 대만(타이베이) 근무가 가능하거나 글로벌 환경을 선호하는 분
- 데이터 분석을 통해 실제 비즈니스 임팩트를 만들어온 경험이 있는 분
