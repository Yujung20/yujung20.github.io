---
layout: post
title: "databricks - Staff Machine Learning Engineer "
date: 2026-06-13
company: "databricks"
...
`GenAI` `LLM` `Machine Learning` `Text-to-SQL` `AI/BI` `NLP` `Python` `MLOps` `Databricks` `Applied AI`

---

## 공고 요약

Databricks의 Applied AI 팀은 Databricks Assistant, AI/BI Genie, Agent Bricks 등 GenAI 기반 제품을 개발하는 팀입니다. 수십만 명의 사용자가 매일 사용하는 제품의 LLM 품질 향상과 GenAI 기능 확장을 담당할 Staff ML Engineer를 찾고 있습니다. 코드 제안, 오류 감지, Text-to-SQL 생성, 자동 파이프라인 생성 등 다양한 GenAI 문제를 해결하는 역할입니다. 2025년에는 LLM 품질 강화, GenAI 기능 확장, 플랫폼 아키텍처 고도화에 집중할 예정입니다.

---

## 필수 지원 조건

- LLM 및 GenAI 모델 개발/파인튜닝 경험
- 대규모 AI 제품의 품질 개선 및 평가 시스템 구축 경험
- Text-to-SQL, 코드 생성 등 언어 모델 응용 분야 실무 경험
- ML 시스템 설계 및 프로덕션 배포 경험 (Staff 레벨 이상)
- Databricks 또는 유사 데이터/AI 플랫폼 활용 경험

---

## 추천 대상

- LLM 기반 GenAI 제품을 프로덕션 환경에서 개발한 경험이 있는 ML 엔지니어
- Text-to-SQL, 코드 자동 완성 등 언어 모델 응용 연구 및 개발 경험자
- 대규모 사용자 트래픽을 처리하는 AI 플랫폼 아키텍처 설계에 관심 있는 시니어 엔지니어
- GenAI 제품의 평가(Evaluation) 및 품질 향상 파이프라인 구축 경험자
- 데이터 분석 및 AI 툴링 분야에서 임팩트 있는 제품을 만들고 싶은 엔지니어
