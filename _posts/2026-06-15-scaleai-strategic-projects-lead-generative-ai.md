---
layout: post
title: "scaleai - Strategic Projects Lead, Generative AI"
date: 2026-06-15
company: "scaleai"
role: "Strategic Projects Lead, Generative AI"
...
`Generative AI` `Strategic Projects` `Cross-functional Leadership` `Product Management` `Data Labeling` `Engagement Manager` `Go-to-Market` `Operations` `Stakeholder Management` `AI/ML`

---

## 공고 요약

Scale AI의 Generative AI 사업부에서 전략 프로젝트를 이끌 리더를 찾고 있습니다. 이 역할은 수천만 달러 규모의 신규 매출을 창출하는 핵심 이니셔티브를 주도하며, 운영자·PM·고객 대면 매니저 등 다양한 역할을 동시에 수행해야 합니다. 엔지니어링, 운영, GTM 팀을 아우르는 크로스펑셔널 프로젝트를 리드하고, 경영진에게 정기적으로 진행 상황을 보고하는 포지션입니다. 강한 기업가적 마인드셋과 실행력을 갖춘 인재를 원하며, 빠른 커리어 성장 기회를 제공합니다.

---

## 필수 지원 조건

- 크로스펑셔널 팀(엔지니어링/운영/영업) 리드 경험
- 프로덕트 매니지먼트 또는 전략 프로젝트 운영 경험
- 고객 대면 커뮤니케이션 및 이해관계자 관리 능력
- 데이터 레이블링 또는 AI/ML 운영 관련 이해
- 경영진 대상 보고 및 발표 경험
...
- 스타트업 또는 빠른 성장 환경에서 전략/운영 프로젝트를 이끌어본 사람
- PM, 컨설턴트, 또는 사업개발 경험을 가진 멀티플레이어형 인재
- AI/ML 산업에 깊은 관심을 가지고 기술과 비즈니스를 연결하고 싶은 사람
- 높은 강도의 업무 환경에서 빠른 커리어 성장을 원하는 사람
- 기업가적 마인드셋으로 오너십을 갖고 일하고 싶은 사람
