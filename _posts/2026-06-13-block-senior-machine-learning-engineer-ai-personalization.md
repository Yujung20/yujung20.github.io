---
layout: post
title: "block - Senior Machine Learning Engineer, AI Personalization"
date: 2026-06-13
company: "block"
role: "Senior Machine Learning Engineer, AI Personalization"
...
`Machine Learning` `LLM` `AI Personalization` `Recommendation Systems` `MLOps` `Deep Learning` `NLP` `Python` `Distributed Systems` `AI Orchestration`

---

## 공고 요약

Block(Square, Cash App 등 운영사)은 AI 개인화 분야의 시니어 ML 엔지니어를 채용합니다. 이 역할은 LLM을 오케스트레이션 레이어로 활용하여 여러 ML 모델을 통합·조율하는 차세대 AI 시스템을 구축하는 것을 핵심으로 합니다. 기존의 단일 태스크 ML 시스템을 넘어, LLM이 모델 호출과 결과 해석을 동적으로 결정하는 새로운 패러다임을 다룹니다. 금융·커머스 플랫폼의 사용자 경험을 개인화하는 대규모 ML 시스템 설계 및 운영 경험이 있는 인재를 찾고 있습니다.

---

## 필수 지원 조건

- LLM 및 대규모 ML 시스템 설계·개발 경험
- 추천 시스템 또는 AI 개인화 시스템 구축 경험
- Python 등을 활용한 ML 모델 학습 및 프로덕션 배포 경험
- 분산 시스템 및 MLOps 파이프라인 운영 능력
- 복잡한 AI 오케스트레이션 로직 설계 및 구현 능력

---

## 추천 대상

- LLM을 활용한 멀티모델 오케스트레이션 시스템 개발에 관심 있는 ML 엔지니어
- 추천 시스템·개인화 AI를 대규모 프로덕션 환경에서 운영해본 경험자
- 핀테크·커머스 도메인에서 ML을 적용한 실무 경험이 있는 개발자
- 연구와 엔지니어링을 균형 있게 수행하며 임팩트 있는 제품을 만들고 싶은 사람
- Bay Area에서 글로벌 금융 인프라를 혁신하는 미션에 공감하는 시니어 엔지니어
