---
layout: post
title: "databricks - Senior Applied AI Engineer"
date: 2026-06-15
company: "databricks"
...
`Machine Learning` `AutoML` `Deep Learning` `Applied AI` `Optimization` `Classification` `Regression` `Forecasting` `Feature Engineering` `Databricks`

---

## 공고 요약

Databricks는 벨그라드에서 AutoML 및 사용자 대면 AI 제품을 개선할 시니어 Applied ML/AI 엔지니어를 찾고 있습니다. 분류, 회귀, 예측, 추천 등 다양한 ML 문제를 통계 모델부터 딥러닝 기반 파운데이션 모델까지 폭넓게 다루는 역할입니다. 소규모 팀에서 엔드투엔드 시스템을 구축하며 제품 및 엔지니어링 팀과 긴밀히 협력해 회사의 ML 전략 방향에도 영향을 미칠 수 있는 고임팩트 포지션입니다.

---

## 필수 지원 조건

- 머신러닝 및 최적화 알고리즘에 대한 깊은 이해와 실무 경험
- 분류, 회귀, 시계열 예측, 추천 시스템 등 다양한 ML 태스크 경험
- 딥러닝 및 파운데이션 모델 활용 경험
- 엔드투엔드 ML 시스템 설계 및 구현 능력
- AutoML 또는 Feature Engineering/Auto-tuning 관련 경험

---

## 추천 대상

- AutoML 및 MLOps 플랫폼 개발에 관심 있는 ML 엔지니어
- 통계 모델부터 최신 딥러닝까지 폭넓은 ML 스택을 경험한 시니어 엔지니어
- 소규모 팀에서 높은 자율성과 임팩트를 원하는 개발자
- 데이터 플랫폼 및 인프라 성능 최적화에 관심 있는 엔지니어
- 세르비아(벨그라드) 거주 또는 이주 가능한 ML 전문가
