---
layout: post
title: "deepmind - Staff AI Product Designer, Growth & Discovery, GeminiApp"
date: 2026-06-15
company: "deepmind"
role: "Staff AI Product Designer, Growth & Discovery, GeminiApp"
...
`AI Product Design` `UX Design` `Growth Design` `Gemini App` `Machine Learning` `Product Strategy` `User Research` `Discovery` `Google DeepMind` `Staff Designer`

---

## 공고 요약

Google DeepMind에서 Gemini 앱의 성장 및 발견(Growth & Discovery) 이니셔티브를 담당할 Staff AI 프로덕트 디자이너를 모집합니다. 수십억 명의 사용자에게 AI 기반의 마법 같은 제품 경험을 제공하는 것을 목표로 하며, 세계 최고 수준의 AI 연구 조직과 긴밀하게 협력하게 됩니다. 고도의 자기 주도성과 혁신적 사고를 갖춘 시니어급 디자이너를 찾고 있으며, 캘리포니아 마운틴뷰 또는 샌프란시스코 오피스 기반으로 근무합니다.

---

## 필수 지원 조건

- Staff 레벨에 해당하는 풍부한 프로덕트 디자인 경험 보유
- AI/ML 기반 제품의 UX 설계 및 Growth 디자인 경험
- 대규모 소비자 제품(B2C)의 성장 및 발견 기능 디자인 역량
- 자기 주도적으로 프로젝트를 이끌 수 있는 리더십과 커뮤니케이션 능력

---

## 추천 대상

- AI 제품 디자인에 깊은 관심을 갖고 있는 시니어/스태프급 UX 디자이너
- Growth 디자인 또는 사용자 획득·리텐션 관련 디자인 경험이 있는 분
- Google, Meta 등 대형 테크 기업의 프로덕트 디자인 경력을 보유한 분
- AI 윤리 및 책임감 있는 AI 개발에 관심이 있는 디자이너
- 연구 중심 조직에서 복잡한 AI 기술을 직관적인 사용자 경험으로 풀어내고 싶은 분
