---
layout: post
title: "databricks -  Staff Data Scientist - Trust and Safety"
date: 2026-06-13
company: "databricks"
role: " Staff Data Scientist - Trust and Safety"
...
`Data Science` `Trust and Safety` `Security` `Compliance` `Data Analysis` `AI` `Cloud` `Governance` `Machine Learning` `Databricks`

---

## 공고 요약

Databricks의 Trust and Safety 데이터 사이언스 팀에서 플랫폼의 보안 및 컴플라이언스를 보장하는 프로젝트를 담당할 Staff Data Scientist를 채용합니다. 3개 클라우드 환경에서 수백만 개의 가상 머신을 운영하는 대규모 플랫폼의 보안 및 데이터 거버넌스 문제를 데이터 기반으로 분석하고 해결하는 역할입니다. 고객의 데이터 안전을 보장하면서 다양한 보안 및 컴플라이언스 요구사항을 충족하는 솔루션 개발에 기여하게 됩니다.

---

## 필수 지원 조건

- 데이터 사이언스 분야의 풍부한 경험 (Staff 레벨에 준하는 시니어급)
- 보안, 컴플라이언스, 또는 Trust & Safety 도메인에 대한 이해 및 경험
- 대규모 클라우드 환경(AWS, GCP, Azure 등)에서의 데이터 분석 경험
- 데이터 기반 의사결정 및 분석 역량 (통계, 머신러닝 등)

---

## 추천 대상

- 보안/컴플라이언스 분야에서 데이터 사이언스를 적용한 경험이 있는 분
- 대규모 클라우드 플랫폼 환경에서 데이터 분석 프로젝트를 수행해 본 분
- Trust & Safety 또는 리스크 탐지 모델링에 관심 있는 시니어 데이터 사이언티스트
- 데이터와 AI 기술로 실제 사회적 문제(보안, 안전)를 해결하고 싶은 분
