---
layout: post
title: "deepmind - Research Engineer, Human Understanding"
date: 2026-06-16
company: "deepmind"
role: "Research Engineer, Human Understanding"
...
`Multimodal AI` `Speech Recognition` `Audio-Visual Modeling` `Deep Learning` `Research Engineering` `Human Understanding` `Generative AI` `Foundation Models` `AGI` `Computer Vision`

---

## 공고 요약

Google DeepMind의 Frontier AI 유닛에서 인간 이해 및 생성을 위한 멀티모달 AI 연구 엔지니어(L5)를 채용합니다. 음성, 오디오, 비주얼 등 다양한 모달리티를 활용해 인간의 모습을 이해하고 생성하는 기반 AI 기술을 개발하는 역할입니다. 최첨단 모델과 프레임워크를 설계 및 구현하며, AGI를 향한 Google DeepMind의 미션에 핵심적으로 기여하게 됩니다. 로스앤젤레스 또는 마운틴뷰에서 근무하며 인간 중심의 AI 연구에 직접적인 영향을 미칠 수 있는 기회입니다.

---

## 필수 지원 조건

- 멀티모달 모델링(음성, 오디오, 비주얼) 분야의 강력한 연구/개발 경험
- 딥러닝 모델 설계 및 대규모 구현 능력
- AI/ML 관련 연구 논문 발표 또는 산업 현장 적용 경험

---

## 추천 대상

- 음성 인식, 오디오-비주얼 AI 분야에서 연구 경험이 있는 엔지니어
- 멀티모달 파운데이션 모델 개발에 관심 있는 ML 연구자
- AGI 및 인간 중심 AI 기술 개발에 열정을 가진 시니어급 연구 엔지니어
- Google DeepMind 수준의 프론티어 AI 연구 환경에서 일하고 싶은 개발자
