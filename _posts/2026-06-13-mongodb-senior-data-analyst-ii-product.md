---
layout: post
title: "mongodb - Senior Data Analyst II, Product"
date: 2026-06-13
company: "mongodb"
role: "Senior Data Analyst II, Product"
location: "Austin"
source: "greenhouse"
...
`Data Analytics` `Product Analytics` `SQL` `Data Management` `Business Intelligence` `Stakeholder Management` `MongoDB` `Data Platform` `Insights` `Engineering Collaboration`

---

## 공고 요약

MongoDB는 빠르게 성장하는 데이터 애널리틱스 팀을 강화할 Senior Data Analyst II를 채용합니다. 이 역할은 Product Management, Engineering, Analytics 팀 등 다양한 이해관계자와 협력하여 비즈니스 의사결정을 위한 핵심 인사이트를 도출하는 것이 주요 업무입니다. 강력한 분석 및 기술 역량과 함께 빠른 속도의 환경에서 여러 조직과 원활히 협업할 수 있는 인재를 찾고 있습니다.

---

## 필수 지원 조건

- 강력한 데이터 분석 및 기술적 역량 보유
- Product Management, Engineering 등 다양한 이해관계자와의 협업 경험
- 빠르게 변화하는 환경에서 복잡한 문제를 분석하고 인사이트를 도출하는 능력
- 다양한 조직 레벨의 stakeholder와 효과적으로 소통하는 커뮤니케이션 능력

---

## 추천 대상

- 데이터 기반 의사결정 문화에서 Product Analytics 경험을 쌓고 싶은 분
- 글로벌 테크 기업에서 데이터 플랫폼 관련 분석 업무를 해보고 싶은 분
- 여러 팀과 협업하며 비즈니스 임팩트를 만드는 데 관심 있는 분
- 빠른 성장 환경에서 커리어를 발전시키고 싶은 시니어 데이터 분석가
