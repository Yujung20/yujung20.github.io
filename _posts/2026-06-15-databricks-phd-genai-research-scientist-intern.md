---
layout: post
title: "databricks - PhD GenAI Research Scientist Intern"
date: 2026-06-15
company: "databricks"
role: "PhD GenAI Research Scientist Intern"
...
`LLM` `GenAI` `Domain Adaptation` `Fine-tuning` `RAG` `AI Research` `NLP` `Compound AI Systems` `Machine Learning` `Enterprise AI`

---

## 공고 요약

Databricks의 Mosaic AI 조직에서 PhD 인턴 Research Scientist를 채용합니다. 주요 임무는 엔터프라이즈 도메인에 특화된 LLM 및 AI 시스템의 도메인 적응(Domain Adaptation) 연구를 추진하는 것입니다. 파인튜닝, 검색 증강 생성(RAG), 에이전트 등 최신 AI 기술을 활용해 고객사의 데이터 기반 AI 모델 개발을 지원합니다. 세계 최고 수준의 데이터·AI 플랫폼을 운영하는 환경에서 실질적인 산업 문제를 해결하는 연구를 수행하게 됩니다.

---

## 필수 지원 조건

- AI/ML, NLP 또는 관련 분야 PhD 과정 재학 중 또는 수료
- 대규모 언어 모델(LLM) 파인튜닝 및 도메인 적응 연구 경험
- RAG, 에이전트 등 복합 AI 시스템에 대한 이해 및 구현 능력
- 머신러닝 프레임워크(PyTorch 등) 활용 능력 및 연구 논문 발표 실적
- 엔터프라이즈 환경의 데이터 및 AI 문제 해결에 대한 관심

---

## 추천 대상

- LLM 파인튜닝 및 도메인 적응 연구를 수행 중인 NLP/ML PhD 연구자
- 산업 현장의 실제 문제에 AI 연구를 적용해보고 싶은 학생
- RAG, AI 에이전트 등 최신 생성형 AI 시스템 개발에 관심 있는 연구자
- 대규모 데이터·AI 플랫폼 환경에서 연구 경험을 쌓고 싶은 인턴 지원자
- 탑티어 AI 기업에서 연구 인턴십을 통해 실무 경력을 원하는 박사 과정생
