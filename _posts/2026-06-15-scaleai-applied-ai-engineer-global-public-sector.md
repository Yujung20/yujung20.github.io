---
layout: post
title: "scaleai - Applied AI Engineer, Global Public Sector"
date: 2026-06-15
company: "scaleai"
role: "Applied AI Engineer, Global Public Sector"
...
`Applied AI` `LLM` `Fine-tuning` `Public Sector` `AI Applications` `Training Data` `Evaluation` `End-to-End AI` `Custom AI` `Generative AI`

---

## 공고 요약

Scale AI의 글로벌 공공 부문 팀은 정부 및 공공기관을 위한 맞춤형 AI 애플리케이션을 구축하는 Applied AI Engineer를 채용합니다. 주요 업무는 수백만 시민에게 영향을 미치는 AI 솔루션 개발, 국가 LLM을 위한 고품질 학습 데이터 생성, 그리고 모델 파인튜닝 및 평가입니다. 카타르 도하 또는 영국 런던에서 근무하며, 공공 부문의 디지털 전환을 AI로 이끌 인재를 찾고 있습니다.

---

## 필수 지원 조건

- 엔드-투-엔드 AI 애플리케이션 개발 경험
- LLM 파인튜닝 및 모델 평가(Evaluation) 실무 경험
- 고품질 AI 학습 데이터셋 생성 및 관리 역량
- 공공 부문 또는 대규모 엔터프라이즈 프로젝트 경험
- 최신 AI/ML 기술 트렌드에 대한 깊은 이해

---

## 추천 대상

- LLM 기반 실제 서비스 개발 및 배포 경험이 있는 AI 엔지니어
- 정부·공공기관 프로젝트에 관심 있고 사회적 임팩트를 추구하는 개발자
- 모델 파인튜닝, 데이터 파이프라인, 평가 시스템을 모두 다뤄본 풀스택 AI 엔지니어
- 중동(카타르) 또는 영국(런던)에서 근무 가능한 글로벌 지향 엔지니어
