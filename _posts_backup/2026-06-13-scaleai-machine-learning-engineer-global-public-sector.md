---
layout: post
title: "scaleai - Machine Learning Engineer, Global Public Sector"
date: 2026-06-13
company: "scaleai"
role: "Machine Learning Engineer, Global Public Sector"
...
`Machine Learning` `AI Research` `Agentic Systems` `LLM` `AI Safety` `Applied Research` `Multi-Agent Systems` `Sovereign AI` `Public Sector AI` `System Architecture`

---

## 공고 요약

Scale AI의 글로벌 공공부문(GPS) 팀은 카타르 도하 및 영국 런던에서 근무할 ML 리서치 엔지니어를 채용합니다. 국가 단위의 LLM 개발, 정부용 AI 애플리케이션 구축 등 고위험·고영향 환경에서 실질적인 AI 연구를 수행합니다. 단순한 도구 구현을 넘어 에이전트 설계, 신뢰성, AI 안전성 분야의 응용 연구를 주도하며, 연구 논문 수준의 아이디어를 프로덕션 시스템으로 전환하는 역할을 담당합니다.

---

## 필수 지원 조건

- 멀티스텝 에이전틱 시스템 설계 및 연구 경험
- LLM 기반 AI 시스템 아키텍처 설계 및 구현 능력
- AI 신뢰성 및 안전성(AI Safety) 관련 연구 또는 실무 경험
- 연구 결과를 프로덕션 수준의 시스템으로 전환한 경험
- 공공/정부 부문 또는 미션 크리티컬 환경에서의 AI 적용 경험 우대

---

## 추천 대상

- 학계 연구와 실제 프로덕션 개발을 모두 경험한 ML 엔지니어
- 에이전트 AI 시스템 및 LLM 응용 연구에 깊은 관심이 있는 사람
- 국가·정부 단위의 대규모 AI 프로젝트에 사회적 임팩트를 주고 싶은 사람
- AI 안전성과 신뢰성 문제를 연구하고 싶은 사람
- 중동(카타르) 또는 영국(런던)에서 글로벌 환경으로 커리어를 확장하고 싶은 사람
