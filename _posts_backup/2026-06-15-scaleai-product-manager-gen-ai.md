---
layout: post
title: "scaleai - Product Manager, Gen AI"
date: 2026-06-15
company: "scaleai"
role: "Product Manager, Gen AI"
...
`Product Manager` `Generative AI` `Data Infrastructure` `AI Training Data` `Marketplace` `Human Feedback` `Model Evaluation` `Data Annotation` `LLM` `Enterprise AI`

---

## 공고 요약

Scale AI는 세계 최고 수준의 AI 모델을 위한 데이터 인프라를 구축하는 회사로, GenAI 조직 내 여러 팀에서 프로덕트 매니저를 채용하고 있습니다. 이 역할은 AI 학습 데이터, 평가 프레임워크, 인간 피드백 시스템을 다루는 양면 마켓플레이스의 제품을 책임집니다. 수요 측면에서는 AI 랩 및 엔터프라이즈 고객을, 공급 측면에서는 전 세계 50만 명 이상의 데이터 기여자를 연결하는 시스템과 툴링을 설계합니다. 뉴욕 또는 샌프란시스코에서 근무하며, AI 데이터 생태계의 핵심 제품을 만들 수 있는 인재를 찾고 있습니다.

---

## 필수 지원 조건

- 프로덕트 매니저로서의 실무 경험 및 복잡한 기술 제품 기획 능력
- AI/ML 또는 데이터 관련 도메인에 대한 깊은 이해
- 마켓플레이스 또는 플랫폼 제품 개발 경험
- 데이터 기반 의사결정 및 다양한 이해관계자와의 협업 능력

---

## 추천 대상

- AI/ML 데이터 파이프라인 또는 학습 데이터 관련 제품 경험이 있는 PM
- 양면 마켓플레이스 또는 플랫폼 비즈니스에서 일해본 프로덕트 매니저
- 생성형 AI 트렌드에 관심이 많고 모델 평가·피드백 시스템을 이해하는 사람
- 대규모 글로벌 운영 환경에서 복잡한 시스템을 설계·개선한 경험자
- AI 랩 또는 엔터프라이즈 AI 팀과 협업한 경험이 있는 기술 PM
