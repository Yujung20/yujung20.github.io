---
layout: post
title: "deepmind - Research Scientist, Recommendation Systems"
date: 2026-06-15
company: "deepmind"
role: "Research Scientist, Recommendation Systems"
...
`Recommendation Systems` `Large Language Models` `Deep Learning` `Foundation Models` `Fine-tuning` `Pre-training` `Tokenization` `Research Scientist` `Behavioral Signals` `AI/ML`

---

## 공고 요약

DeepMind의 추천 시스템 팀은 LLM과 복잡한 사용자 행동 신호를 결합한 차세대 대규모 추천 모델을 개발하는 Research Scientist를 찾고 있습니다. 해당 직무는 사용자·아이템 토크나이제이션, 지속적 사전학습, 고급 파인튜닝 기법을 활용해 추천 전용 파운데이션 모델을 구축하는 역할입니다. Google의 주요 제품에 직접 배포되는 대규모 AI 시스템 연구를 수행하며, LLM의 콘텐츠 이해 및 추론 능력을 추천 도메인에 통합하는 새로운 패러다임을 개척합니다. 연구 결과가 실제 프로덕트에 적용되는 임팩트 높은 환경에서 일하고 싶은 연구자에게 적합한 포지션입니다.

---

## 필수 지원 조건

- 추천 시스템 또는 딥러닝 분야의 연구 경험 및 관련 논문 실적
- 대규모 언어 모델(LLM) 및 파운데이션 모델에 대한 깊은 이해
- 사전학습(Pre-training) 및 파인튜닝(Fine-tuning) 기법에 대한 실무 경험
- 머신러닝/딥러닝 관련 박사 학위 또는 동등한 연구 경력
- 대규모 분산 시스템 환경에서의 모델 학습 및 배포 경험

---

## 추천 대상

- 추천 시스템과 LLM을 융합한 연구에 관심 있는 AI 연구자
- 학문적 연구 결과를 Google 규모의 실제 프로덕트에 적용하고 싶은 사람
- 사용자 행동 데이터 모델링 및 순차적 추천 모델 연구 경험자
- 파운데이션 모델의 새로운 응용 도메인을 개척하고 싶은 연구자
- 대규모 산업 환경에서 임팩트 있는 연구를 원하는 딥러닝 전문가
