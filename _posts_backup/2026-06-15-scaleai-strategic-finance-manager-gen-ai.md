---
layout: post
title: "scaleai - Strategic Finance Manager, Gen AI"
date: 2026-06-15
company: "scaleai"
role: "Strategic Finance Manager, Gen AI"
...
`Strategic Finance` `Financial Forecasting` `Generative AI` `FP&A` `Business Partnering` `Data-Driven Decision Making` `Financial Modeling` `Go-to-Market` `High-Growth Startup`

---

## 공고 요약

Scale AI는 빠르게 성장하는 Generative AI 비즈니스를 지원할 Strategic Finance Manager를 찾고 있습니다. 이 역할은 Product, Operations, Growth, GTM 리더들과 긴밀히 협력하여 재무적 엄밀성과 전략적 인사이트를 제공하는 것이 핵심입니다. 4~6년의 고성장 환경 경험을 보유한 분석력과 비즈니스 감각을 겸비한 재무 전문가를 선호합니다. GenAI 사업부의 재무 예측 모델을 주도적으로 운영하며 확장 가능한 시스템 구축에 기여하게 됩니다.

---

## 필수 지원 조건

- 4~6년의 재무 관련 경험 (FP&A, 전략 재무, 투자은행, 컨설팅 등 고성장 환경 선호)
- 재무 모델링 및 예측(Forecasting) 역량 보유
- 비즈니스 파트너링 경험 및 리더십 팀과의 협업 능력
- 데이터 기반 의사결정 및 분석적 사고력
- 불확실한 환경에서 다수의 업무를 동시에 처리할 수 있는 실행력

---

## 추천 대상

- FP&A 또는 전략 재무 경험을 보유하고 테크 스타트업으로 이직을 원하는 분
- AI/테크 산업의 빠른 성장 환경에서 전략적 역할을 원하는 재무 전문가
- 단순 숫자 관리보다 비즈니스 전략에 직접 기여하고 싶은 분
- 모호한 상황에서도 주도적으로 문제를 정의하고 해결할 수 있는 분
- 투자은행이나 컨설팅 출신으로 사업회사 재무 커리어를 시작하려는 분
