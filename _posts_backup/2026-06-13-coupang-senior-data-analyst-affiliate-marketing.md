---
layout: post
title: "coupang - Senior Data Analyst, Affiliate Marketing"
date: 2026-06-13
company: "coupang"
role: "Senior Data Analyst, Affiliate Marketing"
...
`Data Analytics` `Affiliate Marketing` `Growth Analytics` `Marketing Operations` `SQL` `Python` `Campaign Analysis` `E-commerce` `Performance Marketing` `Dashboard`

---

## 공고 요약

쿠팡 대만 법인에서 어필리에이트 마케팅 운영을 지원할 시니어 데이터 애널리스트를 채용합니다. Growth Analytics 팀 소속으로 다양한 어필리에이트 채널의 마케팅 캠페인 분석 및 운영을 담당합니다. 로켓배송, 로켓직구 등 대만 서비스 확장을 데이터 기반으로 지원하는 핵심 역할입니다. 빠르게 성장하는 이커머스 환경에서 마케팅 성과를 분석하고 인사이트를 도출할 수 있는 인재를 찾고 있습니다.
...
- SQL 및 데이터 분석 툴 활용 능력
- 어필리에이트 또는 퍼포먼스 마케팅 도메인 이해
- 마케팅 캠페인 분석 및 리포팅 경험
- 영어 또는 중국어(번체) 비즈니스 커뮤니케이션 가능
...
- 어필리에이트 마케팅 채널 운영 및 성과 측정에 관심 있는 분
- 대만 또는 아시아 시장 확장 경험을 원하는 데이터 전문가
- 빠르게 성장하는 스타트업 환경에서 일하고 싶은 분
