---
layout: post
title: "databricks - Principal Research Scientist – Scaling"
date: 2026-06-15
company: "databricks"
role: "Principal Research Scientist – Scaling"
...
`LLM` `Scaling` `AI Research` `Large Language Models` `Post-training` `Inference Efficiency` `Multi-agent` `Deep Learning` `NLP` `Distributed Systems`

---

## 공고 요약

Databricks AI Research팀의 Scaling 분야 Principal Research Scientist를 모집합니다. 이 팀은 대규모 언어 모델(LLM)의 학습 및 추론 효율성을 극한까지 끌어올리는 연구에 집중합니다. 알고리즘, 시스템 등 다방면에서 스케일링 혁신을 추구하며, 오픈소스 LLM 후처리부터 멀티에이전트 아키텍처까지 폭넓은 AI 기술을 다룹니다. 세계 최고 수준의 데이터 및 AI 플랫폼을 구축하는 환경에서 연구 역량을 발휘할 인재를 찾고 있습니다.

---

## 필수 지원 조건

- 대규모 언어 모델(LLM) 학습 및 추론 효율화에 대한 심층적인 연구 경험
- 스케일링 알고리즘 및 시스템 최적화 분야의 독립적 연구 수행 능력
- 관련 분야 박사 학위 또는 그에 준하는 연구 실적 및 경력
- 머신러닝/딥러닝 시스템에 대한 이론 및 실무 전반의 전문 지식

---

## 추천 대상

- LLM 스케일링 법칙 및 효율적 학습 방법론 연구에 열정이 있는 분
- AI 연구 결과를 실제 프로덕션 환경에 적용하는 경험을 원하는 분
- 오픈소스 AI 생태계에 기여하며 임팩트 있는 연구를 하고 싶은 분
- 알고리즘과 시스템을 아우르는 풀스택 AI 연구에 관심 있는 분
